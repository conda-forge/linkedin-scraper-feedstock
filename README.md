...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/linkedin-scraper-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14683&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/linkedin-scraper-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `linkedin-scraper` can be installed with:

```
conda install linkedin-scraper
```

It is possible to list all of the versions of `linkedin-scraper` available on your platform with:
